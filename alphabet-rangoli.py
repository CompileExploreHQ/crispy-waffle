...
def print_rangoli(size):
    ...
    # Initialize the rangoli array
    rangoli = []

    # Iterate through each line of the pattern
    for i in range(size):
        # Create the left half of the line
        left_half = '-'.join(alphabets[size-1:i:-1] + alphabets[i:size])

        # Center the left half and fill it to the width
        line = left_half.center(width, '-')

        # Append the line to the rangoli array
        rangoli.append(line)
